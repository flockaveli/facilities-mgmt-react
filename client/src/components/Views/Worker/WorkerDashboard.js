...
import { Row, Col, Button, Container, Form, Input } from 'react-bootstrap'
...
const WorkerDashboard = () => {
    ...
    const { requests, categories, user, isFetching } = state
    ...
    const getCategoryDetails = () => {
        RequestDataService.getWorkerCategoryCount(user._id)
            .then(response => {
